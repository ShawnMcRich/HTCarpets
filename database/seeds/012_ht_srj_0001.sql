-- Live catalog record: HT-SRJ-0001.
...
values ('sirjan', 'سیرجان', 'Sirjan', 'کرمان', 'سیرجان؛ از مراکز بافت‌های عشایری و روستایی در استان کرمان.')
...
values ('tribal', 'عشایری', 'Tribal', 'نقشه‌ای با نقش‌های هندسی، درختی و نمادهای تصویریِ ساده‌شده.')
on conflict (slug) do update set
  name_fa = excluded.name_fa,
  name_en = excluded.name_en,
  description_fa = excluded.description_fa;
...
select
  'HT-SRJ-0001', 'home', 'active',
  'قالی عشایریِ سیرجان', 'Sirjan Tribal Rug',
  'قالی سیرجان با بافت عشایری، نقشه‌ی هندسی و زمینه‌ی کرم، لاکی و سرمه‌ای.',
  origins.id, patterns.id, 'rectangular', 118, 163, '۱۱۸ × ۱۶۳ سانتی‌متر',
  'حدود ۴۰ تا ۵۰ سال؛ برآورد تقریبی.', 45, 2, 'unknown',
  'بنا بر اعلام مالک: وضعیت بسیار خوب و بافت پُرگوشت و ضخیم. تأیید نهایی نیازمند بررسی کارشناسی است.',
  35000000, 'public', false, true
from origins
join patterns on patterns.slug = 'tribal'
where origins.slug = 'sirjan'
...
cross join (
  values
    ('media/products/ht-srj-0001/full-frontal.png', 'image/png', 2725878::bigint, 'full_frontal', 'نمای روبه‌روی کامل قالی عشایری سیرجان', 0, true),
    ('media/products/ht-srj-0001/studio-three-quarter.png', 'image/png', 2696099::bigint, 'three_quarter', 'نمای زاویه‌دار قالی عشایری سیرجان', 1, false),
    ('media/products/ht-srj-0001/low-angle.png', 'image/png', 2491743::bigint, 'three_quarter', 'نمای کم‌ارتفاع از قالی عشایری سیرجان', 2, false),
    ('media/products/ht-srj-0001/tribal-detail.jpg', 'image/jpeg', 3439746::bigint, 'field_detail', 'جزئیات ترنج و نقوش هندسیِ قالی عشایری سیرجان', 3, false),
    ('media/products/ht-srj-0001/sirjan-context.png', 'image/png', 3161646::bigint, 'in_room', 'قالی عشایری سیرجان در فضای معماری بومی', 4, false)
) as image(storage_key, mime_type, byte_size, kind, alt_fa, sort_order, is_primary)
where products.sku = 'HT-SRJ-0001'
