-- Live catalog record: HT-RVR-0001.
...
values ('raver', 'راور', 'Ravar', 'کرمان', 'راور، کرمان.')
...
values ('one-sided-tree', 'درختی یک‌طرفه', 'One-sided Tree', 'نقشه‌ای جهت‌دار با درختِ مرکزی، گل‌ها و پرندگان.')
on conflict (slug) do update set
  name_fa = excluded.name_fa,
  name_en = excluded.name_en,
  description_fa = excluded.description_fa;
...
select
  'HT-RVR-0001', 'antique', 'active',
  'درختیِ راور', 'Ravar One-sided Tree',
  'فرش آنتیک راورِ کرمان با زمینه‌ی سرمه‌ای، نقشه‌ی درختی یک‌طرفه، گل‌ها و پرندگان.',
  origins.id, patterns.id, 'rectangular', 136, 213, '۱۳۶ × ۲۱۳ سانتی‌متر',
  'حدود ۱۱۰ تا ۱۴۰ سال؛ بازه‌ی تقریبی.', 125, 3, 'unknown',
  'بنا بر اعلام مالک: وضعیت بسیار خوب. بررسی و مستندسازی نهایی پیش از خرید انجام می‌شود.',
  138000000, 'public', false, true
from origins
join patterns on patterns.slug = 'one-sided-tree'
where origins.slug = 'raver'
...
where products.sku = 'HT-RVR-0001'
...
cross join (
  values
    ('media/products/ht-rvr-0001/full-frontal.png', 'image/png', 3398797::bigint, 'full_frontal', 'نمای روبه‌روی کامل فرش آنتیک راور با نقشه‌ی درختی یک‌طرفه', 0, true),
    ('media/products/ht-rvr-0001/studio-three-quarter.png', 'image/png', 3148294::bigint, 'three_quarter', 'نمای زاویه‌دار فرش راور با زمینه‌ی سرمه‌ای و حاشیه‌ی لاکی', 1, false),
    ('media/products/ht-rvr-0001/tree-and-birds-detail.jpg', 'image/jpeg', 4787722::bigint, 'field_detail', 'جزئیات درخت، گل‌ها و پرندگان در بافت فرش راور', 2, false),
    ('media/products/ht-rvr-0001/kerman-architecture-context.png', 'image/png', 3363552::bigint, 'in_room', 'فرش درختی راور در نمای معماریِ کرمان', 3, false)
