-- Live catalog record: HT-QOM-0002.
...
select
  'HT-QOM-0002', 'home', 'active',
  'شکارگاهِ لاجوردیِ قم', 'Qom Navy Hunting Scene',
  'فرش دستباف قدیمی قم با نقشه‌ی شکارگاه، زمینه‌ی سرمه‌ای، سواران، جانوران و حاشیه‌ی آبی.',
  origins.id, patterns.id, 'rectangular', 142, 215, '۱۴۲ × ۲۱۵ سانتی‌متر',
  'حدود ۴۰ سال؛ برآورد تقریبی.', 40, 3, 'unknown',
  250000000, 'public', false, true
from origins
...
select products.id, materials.id, 'pile', 'بخشی از پرز ابریشم است؛ ترکیب سایر الیاف در دست تکمیل است.'
from products
join materials on materials.code = 'silk'
where products.sku = 'HT-QOM-0002'
...
cross join (
  values
    ('media/products/ht-qom-0002/full-frontal.png', 'image/png', 3183441::bigint, 'full_frontal', 'نمای روبه‌روی کامل فرش قدیمی قم با نقشه‌ی شکارگاه و زمینه‌ی سرمه‌ای', 0, true),
    ('media/products/ht-qom-0002/studio-three-quarter.png', 'image/png', 3197566::bigint, 'three_quarter', 'نمای زاویه‌دار فرش شکارگاه قم با حاشیه‌ی آبی', 1, false),
    ('media/products/ht-qom-0002/hunting-scene-detail.jpg', 'image/jpeg', 4036096::bigint, 'field_detail', 'جزئیات سواران، اسب‌ها و جانوران در نقشه‌ی شکارگاه فرش قم', 2, false),
    ('media/products/ht-qom-0002/hunting-interior-context.png', 'image/png', 3581556::bigint, 'in_room', 'فرش شکارگاه قم در فضایی با معماری ایرانی', 3, false)
